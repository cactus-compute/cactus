...
SUPPORTED_FAMILIES = {"auto", "gemma3", "gemma4", "qwen", "lfm2", "whisper", "parakeet", "parakeet_tdt", "moonshine", "nomic", "needle", "taesd", "generic"}

DIFFUSERS_FAMILIES = {"AutoencoderTiny": "taesd"}


def detect_family(config, requested: str = "auto") -> str:
    if requested != "auto":
        return requested
    diffusers_class = str(cfg_get(config, "_class_name", "") or "")
    if diffusers_class in DIFFUSERS_FAMILIES:
        return DIFFUSERS_FAMILIES[diffusers_class]
