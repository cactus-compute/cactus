...
FUSIONS: dict[str, M.FusionDefinition] = {
    **DIRECT_DEFINITIONS,
    "linear": _definition("linear", "linear", LINEAR_GRAPH, fusion_fields=("generic", "linear")),
    "linear_native": _definition("linear_native", "linear", LINEAR_NATIVE_GRAPH, fusion_fields=("generic", "linear")),
    "linear_transposed": _definition("linear_transposed", "linear", LINEAR_TRANSPOSED_GRAPH, fusion_fields=("generic", "linear")),
    "linear_addmm_bias": _definition("linear_addmm_bias", "linear", LINEAR_ADDMM_BIAS_GRAPH, fusion_fields=("generic", "linear")),
    "linear_addmm_transposed_bias": _definition("linear_addmm_transposed_bias", "linear", LINEAR_ADDMM_TRANSPOSED_BIAS_GRAPH, fusion_fields=("generic", "linear")),
    ...
    "rms_norm_cast_weight_left": _definition("rms_norm_cast_weight_left", "rms_norm", RMS_NORM_CAST_WEIGHT_LEFT_GRAPH, fusion_fields=("generic", "rmsnorm", "lfm_rmsnorm", "lfm_moe")),
    ...
    "layernorm_direct": _definition("layernorm_direct", "layernorm", LAYERNORM_DIRECT_GRAPH, fusion_fields=("generic", "normalization")),
    ...
    "whisper_attention_layout": _definition(
        "whisper_attention_layout",
        "attention",
        WHISPER_ATTENTION_LAYOUT_GRAPH,
        fusion_fields=("attention", "whisper_attention"),
        supported_modalities=("audio",),
        metadata={"special_matcher": "whisper_attention_layout"},
    ),
    "whisper_self_attention_cached": _definition(
        "whisper_self_attention_cached",
        "attention_cached",
        WHISPER_ATTENTION_LAYOUT_GRAPH,
        fusion_fields=("attention", "whisper_attention", "cache"),
        supported_modalities=("audio",),
    ...
    "gemma4_bmm_masked_attention": _definition(
        ...
        "attention",
        LFM_BMM_MASKED_ATTENTION_GRAPH,
        fusion_fields=("gemma4_attention",),
        metadata={"special_matcher": "gemma4_attention_layout"},
    ),
    "lfm_bmm_masked_attention": _definition(
        "lfm_bmm_masked_attention",
        "attention",
        LFM_BMM_MASKED_ATTENTION_GRAPH,
        fusion_fields=("lfm_attention", "lfm_moe"),
        metadata={"special_matcher": "lfm_bmm_masked_attention"},
    ),
    "rope": _definition("rope", "rope", ROPE_GRAPH, fusion_fields=("generic", "rope", "gemma4_rope", "qwen2_5_rope")),
    "conv": _definition("conv", "conv1d", CONV_GRAPH, fusion_fields=("generic", "conv", "audio", "vision"), metadata=_required_attrs(padding=0, dilation=1, groups=1, spatial_dims=1)),
    "conv_bias": _definition("conv_bias", "conv1d", CONV_BIAS_GRAPH, fusion_fields=("generic", "conv", "audio", "vision"), metadata=_required_attrs(spatial_dims=1)),
    ...
    "conv2d_depthwise_k3s2p1": _definition("conv2d_depthwise_k3s2p1", "conv2d_depthwise_k3s2p1", CONV_GRAPH, fusion_fields=("generic", "conv", "vision"), metadata=_required_attrs(kernel_size=3, stride=2, padding=1, depthwise=True, spatial_dims=2)),
    "conv2d_pointwise_1x1": _definition("conv2d_pointwise_1x1", "conv2d_pointwise_1x1", CONV_GRAPH, fusion_fields=("generic", "conv", "vision"), metadata=_required_attrs(kernel_size=1, spatial_dims=2)),
    ...
    "lfm_grouped_moe_silu": _definition("lfm_grouped_moe_silu", "moe_layer_gated", LFM_GROUPED_MOE_SILU_GRAPH, fusion_fields=("generic", "moe", "lfm_moe")),
    "lfm_grouped_moe_silu_no_token_clone": _definition("lfm_grouped_moe_silu_no_token_clone", "moe_layer_gated", LFM_GROUPED_MOE_SILU_NO_TOKEN_CLONE_GRAPH, fusion_fields=("generic", "moe", "lfm_moe")),
    "lfm_grouped_moe_direct_router": _definition("lfm_grouped_moe_direct_router", "moe_layer_gated", LFM_GROUPED_MOE_DIRECT_ROUTER_GRAPH, fusion_fields=("generic", "moe", "lfm_moe")),
    "lfm_grouped_moe_direct_router_no_token_clone": _definition("lfm_grouped_moe_direct_router_no_token_clone", "moe_layer_gated", LFM_GROUPED_MOE_DIRECT_ROUTER_NO_TOKEN_CLONE_GRAPH, fusion_fields=("generic", "moe", "lfm_moe")),
    "lfm_grouped_moe_silu_direct_router": _definition("lfm_grouped_moe_silu_direct_router", "moe_layer_gated", LFM_GROUPED_MOE_SILU_DIRECT_ROUTER_GRAPH, fusion_fields=("generic", "moe", "lfm_moe")),
    "lfm_grouped_moe_silu_direct_router_no_token_clone": _definition("lfm_grouped_moe_silu_direct_router_no_token_clone", "moe_layer_gated", LFM_GROUPED_MOE_SILU_DIRECT_ROUTER_NO_TOKEN_CLONE_GRAPH, fusion_fields=("generic", "moe", "lfm_moe")),
    ...
    "gemma4_rope_cos_table": _definition(
        "gemma4_rope_cos_table",
        "gemma4_rope_table_lookup",
        GEMMA4_ROPE_COS_TABLE_GRAPH,
        fusion_fields=("gemma4_attention", "gemma4_rope"),
        supported_inference_modes=("prefill_with_cache", "decode_with_cache"),
        metadata={"special_matcher": "gemma4_rope_table_lookup", "table_kind": "cos"},
    ),
    "gemma4_rope_sin_table": _definition(
        "gemma4_rope_sin_table",
        "gemma4_rope_table_lookup",
        GEMMA4_ROPE_SIN_TABLE_GRAPH,
        fusion_fields=("gemma4_attention", "gemma4_rope"),
        supported_inference_modes=("prefill_with_cache", "decode_with_cache"),
