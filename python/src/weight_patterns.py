...
def get_layer_weight_patterns(i, precision, model_type=None):
    ...
    patterns = [
        ...
        (['altup.prediction_coefs.weight'], precision, f'layer_{i}_altup_prediction_coefs.weights', False),
        (['altup.correction_coefs.weight'], precision, f'layer_{i}_altup_correction_coefs.weights', False),
        (['altup.correct_output_scale'], precision, f'layer_{i}_altup_correct_output_scale.weights', False),
