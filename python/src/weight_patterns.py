...
def get_layer_weight_patterns(i, precision, model_type=None, skip_kv=False):
    ...
    patterns = [
        ...
        (['self_attn.q_proj.bias', 'attn.q_proj.bias'], 'FP16', f'layer_{i}_attn_q_bias.weights', False) if not is_whisper and not is_youtu else None,
        ...
        (['self_attn.k_proj.bias', 'attn.k_proj.bias'], 'FP16', f'layer_{i}_attn_k_bias.weights', False) if not is_whisper and not skip_kv and not is_youtu else None,
        ...
        (['self_attn.v_proj.bias', 'attn.v_proj.bias'], 'FP16', f'layer_{i}_attn_v_bias.weights', False) if not is_whisper and not skip_kv and not is_youtu else None,
        ...
        (['self_attn.o_proj.bias', 'attn.o_proj.bias'], 'FP16', f'layer_{i}_attn_output_bias.weights', False) if not is_whisper else None,
