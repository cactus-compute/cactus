...
3. Copy `CactusHttp.java` to `app/src/main/java/com/cactus/` (required for HTTP support)
...
Test network connectivity from native code:
...
object Cactus {
    ...
    fun testHttp(url: String): String
}
