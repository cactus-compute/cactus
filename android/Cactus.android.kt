...
private object CactusJNI {
    ...
    @JvmStatic external fun nativeDiarize(handle: Long, audioPath: String?, pcmData: ByteArray?): String
    @JvmStatic external fun nativeEmbedSpeaker(handle: Long, audioPath: String?, pcmData: ByteArray?): String
...
actual fun cactusDiarize(model: Long, audioPath: String?, pcmData: ByteArray?): String =
    CactusJNI.nativeDiarize(model, audioPath, pcmData)
actual fun cactusEmbedSpeaker(model: Long, audioPath: String?, pcmData: ByteArray?): String =
    CactusJNI.nativeEmbedSpeaker(model, audioPath, pcmData)
