//==============================================================================
// Auto Generated Code for CactusMatMulPackage
//==============================================================================
 ...
 */
DECLARE_PKG_OPS_OPTS_LIST(PKG_CactusMatMul)
...
static std::array<const char*, 1> sg_opNames{{"CactusMatMul"}};
 ...
 * can be set by Qnn_ErrorHandle_t CactusMatMulPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t CactusMatMulPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t CactusMatMulPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t CactusMatMulPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t CactusMatMulPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t CactusMatMulPackageLogTerminate() {
...
Qnn_ErrorHandle_t CactusMatMulPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "CactusMatMul"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t CactusMatMulPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t CactusMatMulPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t CactusMatMulPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t CactusMatMulPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t CactusMatMulPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t CactusMatMulPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = CactusMatMulPackageInit;
  interface->v1_4.terminate        = CactusMatMulPackageTerminate;
  interface->v1_4.getInfo          = CactusMatMulPackageGetInfo;
  interface->v1_4.validateOpConfig = CactusMatMulPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = CactusMatMulPackageLogInitialize;
  interface->v1_4.logSetLevel      = CactusMatMulPackageLogSetLevel;
  interface->v1_4.logTerminate     = CactusMatMulPackageLogTerminate;
  return QNN_SUCCESS;
}
