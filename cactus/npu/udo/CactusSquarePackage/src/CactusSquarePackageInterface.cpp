//==============================================================================
// Auto Generated Code for CactusSquarePackage
//==============================================================================
 ...
 */
DECLARE_PKG_OPS_OPTS_LIST(PKG_Square)
...
static std::array<const char*, 1> sg_opNames{{"Square"}};
 ...
 * can be set by Qnn_ErrorHandle_t CactusSquarePackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t CactusSquarePackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t CactusSquarePackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t CactusSquarePackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t CactusSquarePackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t CactusSquarePackageLogTerminate() {
...
Qnn_ErrorHandle_t CactusSquarePackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "Square"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t CactusSquarePackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t CactusSquarePackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t CactusSquarePackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t CactusSquarePackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t CactusSquarePackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t CactusSquarePackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = CactusSquarePackageInit;
  interface->v1_4.terminate        = CactusSquarePackageTerminate;
  interface->v1_4.getInfo          = CactusSquarePackageGetInfo;
  interface->v1_4.validateOpConfig = CactusSquarePackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = CactusSquarePackageLogInitialize;
  interface->v1_4.logSetLevel      = CactusSquarePackageLogSetLevel;
  interface->v1_4.logTerminate     = CactusSquarePackageLogTerminate;
  return QNN_SUCCESS;
}
