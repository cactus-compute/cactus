...
class GraniteModel : public Model {
public:
    GraniteModel();
    explicit GraniteModel(const Config& config);
    ~GraniteModel() override = default;
...
private:
    ...
    float logits_scaling_ = 1.0f;
    float embedding_multiplier_ = 1.0f;
