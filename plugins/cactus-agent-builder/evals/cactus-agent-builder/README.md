...
These eval cases check the behavior of the `cactus-agent-builder` agent plugin, not Cactus itself. They are meant to verify that the plugin produces useful plans, safe boundaries, and concrete acceptance checks for common Cactus workflows.
