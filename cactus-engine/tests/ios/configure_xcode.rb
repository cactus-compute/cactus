...
target.build_configurations.each do |config|
  ...
  ['-framework Foundation', '-framework Accelerate', '-framework CoreML', '-framework Security', '-framework SystemConfiguration', '-framework CFNetwork', '-framework Metal', '-framework MetalPerformanceShaders'].each do |framework|
