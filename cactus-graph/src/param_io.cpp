...
const Schema& op_schema(OpType op_type) {
    ...
    static const std::unordered_map<OpType, Schema> kSchemas = {
        ...
        {OpType::SCALAR_EQUAL, {{ParamField::Scalar, FieldPersistence::Persistent}}},
        {OpType::SCALAR_LESS, {{ParamField::Scalar, FieldPersistence::Persistent}}},
        {OpType::SCALAR_LESS_EQUAL, {{ParamField::Scalar, FieldPersistence::Persistent}}},
        {OpType::SCALAR_GREATER, {{ParamField::Scalar, FieldPersistence::Persistent}}},
        {OpType::SCALAR_GREATER_EQUAL, {{ParamField::Scalar, FieldPersistence::Persistent}}},
        ...
        {OpType::EXPAND, {{ParamField::NewShape, FieldPersistence::Persistent}}},
        ...
        {OpType::STRIDED_SLICE, {{ParamField::Axis, FieldPersistence::Persistent}, {ParamField::SliceStart, FieldPersistence::Persistent}, {ParamField::SliceLength, FieldPersistence::Persistent}, {ParamField::Stride, FieldPersistence::Persistent}}},
        {OpType::UNFOLD, {{ParamField::Axis, FieldPersistence::Persistent}, {ParamField::KernelSize, FieldPersistence::Persistent}, {ParamField::Stride, FieldPersistence::Persistent}}},
        {OpType::PAD, {{ParamField::NewShape, FieldPersistence::Persistent}, {ParamField::Scalar, FieldPersistence::Persistent}}},
        ...
        {OpType::ATTENTION_INT8_HYBRID, {
            ...
            {ParamField::IsCausal, FieldPersistence::Persistent},
            {ParamField::AttentionMaskIsAdditive, FieldPersistence::Persistent},
        ...
        {OpType::DENSE_MLP_TQ_FUSED, {{ParamField::Scalar, FieldPersistence::Persistent}, {ParamField::Scale, FieldPersistence::Persistent}}},
        ...
        {OpType::CONV1D, {{ParamField::Stride, FieldPersistence::Persistent}, {ParamField::NumGroups, FieldPersistence::Persistent}}},
